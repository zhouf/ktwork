...
1.输人一个角度值，例如30,求其正弦丽数值(结果保留两位小数)。

2.按二进制打印一个整数。例如将135打印成10000111.

3.输人十六进制的字符串，转换为整数输出。

4.将二进制字符串转換为整数输出。

5.打印1~ 100的所有质数(又称素数)。素数是指只能被1和它自身整除的数，例如3、5、7、9、11、13、17、19等,规定1和2不是质数。
